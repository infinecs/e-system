                        ...
                        <div class="gap-col d-flex justify-content-end">
                            <ul class="gap g-2">
                                <li class="d-none d-md-block">
                                    <a href="/admin/profileEdit" class="btn btn-soft btn-success"><em class="icon ni ni-upload"></em><span>Upload New Photo</span></a>
                                </li>
                                <li class="d-md-none">
                                    <a href="/admin/profileEdit" class="btn btn-soft btn-success btn-icon"><em class="icon ni ni-upload"></em></a>
                                </li>
                            </ul>
                            &nbsp;
                            <ul class="gap g-2">
                                    ...
                                    <div class="card-content col-sep">
                                        <div class="card-body">
                                            <div class="bio-block">
                                                ...
                                                <p><strong>Hey, I'am Faris Razhi</strong> I code and design websites worldwide. Mauris varius tellus vitae tristique sagittis. Sed aliquet, est nec auctor aliquet, orci ex vestibulum ex, non pharetra lacus erat ac nulla.</p>
