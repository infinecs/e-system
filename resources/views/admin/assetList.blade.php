                            ...
                            <table class="datatable-init table small-font-datatable" data-nk-container="table-responsive table-border">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $key + 1 }}</td>
                                        <td>
                                            <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#scrollable">
                                                <img src="{{ asset('images/devices/' . $Data->device_image) }}" style="width: 100%;" alt="Device Image">
                                            </button>
                                            ...
                                            <div class="modal fade" id="scrollable" data-bs-keyboard="false" tabindex="-1" aria-labelledby="scrollableLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-scrollable">
                                                    <div class="modal-content">
                                                        ...
                                                        <h5 class="modal-title" id="scrollableLabel">Device Image Enlarged</h5>
