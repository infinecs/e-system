                                            ...
                                            <a href="#" data-bs-toggle="dropdown">
                                                <div class="d-sm-none">
                                                    <div class="media media-md media-circle">
                                                        <img src="profile_avatar/avatar_image.jpg" alt="img" class="img-thumbnail">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-md">
                                                <div class="dropdown-content dropdown-content-x-lg py-3 border-bottom border-light">
                                                    <div class="media-group">
                                                        <div class="media media-xl media-middle media-circle"><img src="profile_avatar/avatar_image.jpg" alt="img" class="img-thumbnail"></div>
